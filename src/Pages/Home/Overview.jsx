...
const Overview = () => {
  return (
    <div className="mt-48 flex flex-row flex-wrap gap-10 justify-center md:px-10 lg:justify-between lg:px-20">
      <div className="flex flex-col gap-5 lg:w-2/5 left">
        ...
        <span className="flex flex-row gap-4">
          <p>
            <FaCheck className="inline" /> On Demand Support
          </p>
          <p>
            <FaCheck className="inline" /> Seamless Cloud Technology
          </p>
        </span>
      ...
      <div className="lg:w-1/2 relative flex flex-col justify-end right">
        <img
          src={imageOverview}
          alt="icon"
