  ...
  const dummyData = [
    {
      ...
      description:
        "Sublime is easy to use and totally customizable to your business needs.",
      ...
      <div className="relative flex flex-col">
        <div className="relative z-20 bg-transparent grid lg:grid-cols-3 md:grid-cols-2 justify-evenly gap-10 mt-10">
          {dummyData.map((data) => (
            <div
              key={data.id}
              className="rounded-xl p-8 flex flex-col gap-8 items-start border-2 border-gray-100 bg-white shadow-lg"
            >
              {data.icon}
        ...
        <div className="absolute z-10 top-40 bottom-30 left-30 right-30 bg-gradient-to-r from-[#FFDD00] to-[#46F883] opacity-56 blur-[89px]"></div>
      </div>
    </div>
  );
};
