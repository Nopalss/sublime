...
const Benefit = () => {
  return (
    <div className="bg-white lg:py-30 pb-20 ">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3  gap-10 sm:px-10 lg:px-30 py-10 justify-center left">
        <div className="flex flex-row lg:flex-col gap-16  w-full  justify-center items-center ">
          <div className="flex flex-col gap-5 w-1/2  xl:w-[270px] ">
            <img src={star2} alt="" className="w-[48px] h-[48px]" />
            <h1 className="text-xl sm:text-2xl">Increased Efficiency</h1>
            <p className="text-sm">
          ...
          <div className=" flex flex-col gap-5 w-1/2  xl:w-[270px]">
            ...
            <h1 className="text-xl sm:text-2xl">Great Communication</h1>
            <p className="text-sm">
        ...
        <div className="flex flex-row lg:flex-col gap-16  xl:ml-0  justify-center items-center">
          <div className="  flex flex-col gap-5  w-1/2">
            <img src={block2} alt="" className="w-[48px] h-[48px]" />
            <h1 className="text-xl sm:text-2xl">Simple Systems</h1>
            <p className="text-sm">
          ...
          <div className=" flex flex-col gap-5 w-1/2">
            ...
            <h1 className="text-xl sm:text-2xl">Easily Customized</h1>
            <p className="text-sm">
