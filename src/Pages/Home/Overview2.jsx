      ...
      <div className='flex flex-col gap-5 w-2/5'>
        ...
        <div className='relative'>
          <div className='relative z-20 flex flex-col gap-6 p-5 bg-white border-2 border-gray-100 rounded-t-xl rounded-bl-xl'>
            <p className='italic'>"Sublime took our business to the next level. It provided the solution we were hunting for at an affordable price and was easy to integrate."</p>
            <div className='flex flex-row gap-3 items-center'>
              <img src={profileIcon} alt='Icon Profile' className='w-15' />
              <span>
              <p className='font-semibold'>Sarah Smith</p>
              <p className='text-sm text-gray-500'>Marketing Leader @Mailchimp</p>
              </span>
            </div>
          </div>
