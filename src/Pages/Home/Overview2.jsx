...
const Overview2 = () => {
  return (
    <div className="my-48 flex flex-row flex-wrap justify-between gap-10 md:px-10 lg:px-20">
      <div className="flex flex-col justify-end order-last lg:w-1/2 lg:order-first relative right">
        <img
          src={imageOverview}
          alt="icon"
      ...
      <div className="flex flex-col gap-5 order-first lg:w-2/5 lg:order-last left">
