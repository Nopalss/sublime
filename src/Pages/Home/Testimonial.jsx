...
const Testimonial = () => {
  ...
  return (
    <Container>
      <div className="flex flex-col gap-10 bottom">
        <div className="flex flex-col mt-48">
          <h4 className="uppercase text-gray-500 text-center">
            Our Testimonials
          </h4>
          <span className="flex flex-row justify-between items-center">
            <img src={starIcon} className="hidden lg:block w-10" />
            <h3 className="text-6xl lg:w-2/3 text-center">
          ...
          <div className="relative z-20 flex flex-col gap-6">
            <div className="flex flex-col gap-6 bg-white border-2 border-gray-100 p-10 rounded-xl shadow">
              <Rating
                style={{ maxWidth: 150 }}
                value={4}
                itemStyles={styleRating}
                readOnly
              />
              <p className="italic">
                "It’s intuitive, functional, easy-to-setup and presents content
            ...
            <div className="flex flex-col gap-6 bg-white border-2 border-gray-100 p-10 rounded-xl shadow">
              ...
              <div className="flex flex-row gap-3 items-center">
                ...
                <span>
                  ...
                  <p className="text-sm text-gray-500">UI Designer @Flowbase</p>
                </span>
              </div>
            </div>
          </div>
