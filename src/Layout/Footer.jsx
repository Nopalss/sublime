...
const Footer = () => {
  return (
    <Container>
      <div className="relative z-30 bg-white py-20 flex flex-row flex-wrap gap-10 justify-between bottom">
        <div className="flex flex-col justify-center items-start gap-6 md:max-w-2/8">
          ...
          <Button customClass="bg-gray-100 rounded-full hover:bg-gray-200">
            (01) 0000 0000
          </Button>
        </div>
      ...
      <div className="relative z-30 flex flex-row flex-wrap gap-5 justify-between items-center py-6">
        <p className="text-gray-600">
          &copy; 2023 Sublime. All rights reserved.
        </p>
        <span className="flex flex-row text-gray-500">
          <button className="py-1 px-5 border-r-2 border-gray-200 rounded-none">
            Legal
          </button>
